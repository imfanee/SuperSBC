...
const cdrCols = `call_uuid, customer_id, carrier_id, src_ip::text AS src_ip, src_port, caller_number_raw, caller_number, called_number_raw, called_number,
	...
	attempts, failover_depth, codec_in, codec_out, media_mode, COALESCE(rtp_stats, 'null'::jsonb) AS rtp_stats, transport_in, transport_out, srtp_in, srtp_out, privacy, sbc_node, billed_at, billed_by, created_at, updated_at`
...
func InsertCDRSetup(ctx context.Context, q Querier, c *model.CDR) error {
	...
	_, err := q.Exec(ctx, `
		INSERT INTO cdrs (call_uuid, customer_id, carrier_id, src_ip, src_port, caller_number_raw, caller_number, called_number_raw, called_number,
		  ...
		  sell_rate_id, sell_rate_per_min, sell_destination, reserved_amount, attempts, sbc_node, billed_at, billed_by, sell_currency, sell_fx, transport_in, srtp_in, privacy)
		VALUES ($1, $2, $3, NULLIF($4, '')::inet, $5, $6, $7, $8, $9, $10, $11, $12::disposition_kind, $13, $14, $15, $16, $17, $18::numeric, $19, $20::numeric, $21::jsonb, $22, $23, $24, $25, COALESCE(NULLIF($26, '')::numeric, 1), $27, $28, $29)
		...
		c.TransportIn, c.SRTPIn, c.Privacy)
	return wrapErr(err)
}
