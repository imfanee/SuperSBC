...
SBC_BAN_WINDOW=5m
SBC_BAN_DURATION=1h
SBC_FIREWALL_EXPORT_FILE=/state/firewall.json
...
# none: no client certificates; in: any certificate chaining to cafile.pem; subjects_in: chain plus a subject listed on a customer (D-67)
SBC_FS_TLS_VERIFY_POLICY=none
SBC_FS_TLS_VERIFY_DEPTH=2
